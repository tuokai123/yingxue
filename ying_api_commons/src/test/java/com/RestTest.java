...
public class RestTest {
	...
	public static void main(String[] args) throws IOException{
		...
		if (methodNumber.equals("1")) {  //指定模板单发
			String sid = "82cd826d3376b7b8d39fc3d6208e3484";
			String token = "19ed58f3082f6d699cb9a27ffb61a2df";
			String appid = "59b2a879a49d43f29827a463b4c0ebb7";
			String templateid = "590644";
			String param = RandomStringUtils.randomNumeric(4);
			String mobile = "13260426185";
			String uid = "";
